...
Using this formula the error for the further data turned out to be \ensuremath{-1.2260063\times 10^{-13}} \\
...
Running this test twice, once for the actual t-value where we know the data and $n$ and one for where we don't know the data or $n$ yields $n = \ensuremath{1.5030914\times 10^{-20}}$ and $n = 520.888$ respectively. \\
...
The randomization test yielded a $p$-value of 0, the same result as all other tests.\\
